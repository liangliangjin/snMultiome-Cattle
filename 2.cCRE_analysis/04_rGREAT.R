##Peak set process
#cat Res/*_mongolian.txt > mongolian.bed
#cat Res/*_leiqiong.txt > leiqiong.bed
#cat Res/*_Cross_IvsT.txt > Cross_IvsT.bed
############################################
#############near gene
library(rtracklayer)
library(rGREAT)
library(ggplot2)
library(tidyverse)
gr_leiqiong = import("/home/Jingliangliang/SC/Peak_df/rGREAT/leiqiong.bed")
...
gr_mongolian = import("set2_mongolian_merge.only.2.bed")
...
gr = import("set2_leiqiong_mongolian_merge.2.bed")
...
tb_leiqiong2<-tb_leiqiong[(tb_leiqiong$fold_enrichment>1.5)&(tb_leiqiong$p_adjust<2.2e-16),]
...
tb_mongolian2<-tb_mongolian[(tb_mongolian$fold_enrichment>1.5)&(tb_mongolian$p_adjust<0.05),]
